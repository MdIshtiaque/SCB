...
@section('content')
    <div
        ...
        <div
            class="flex items-center justify-center flex-col gap-5 max-w-3xl border bg-white bg-opacity-10 text-center mx-auto p-5 text-white backdrop-blur-sm">
        ...
        <a href="{{ route('home') }}"
            class="bg-transparent border rounded-full px-6 py-2 text-white flex items-center gap-3 hover:bg-gray-500"
            href="">
