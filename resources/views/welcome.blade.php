...
<div class="absolute h-full top-0 left-1/2 transform -translate-x-1/2 w-full max-w-7xl p-8 bg-transparent text-white">
    <h1 class="title text-2xl min-w-64 mt-24 lg:mt-36 lg:text-5xl mb-4 text-center mx-auto leading-8 py-3 drop-shadow-2xl">
        <span><svg class="inline-block mr-1 lg:mr-2 h-2 lg:h-5" viewBox="0 0 24 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8.47721 16.9384C10.5183 16.9384 11.9709 16.2916 13.388 15.3747L23.9999 8.47019L13.388 1.56572C11.9579 0.644437 10.4559 0.000229891 8.47721 0.000229891C3.82689 0.000229891 -5.96046e-05 3.82349 -5.96046e-05 8.46932C-5.96046e-05 13.1152 3.82689 16.9384 8.47721 16.9384Z" fill="#0473EA" />
            </svg></span>Exclusive
        Priority
        Banking
        <span class="block">Privileges that Include your
            family too<svg class="inline-block ml-1 lg:ml-2 h-2 lg:h-5" viewBox="0 0 24 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.5227 0C13.4816 0 12.029 0.646806 10.612 1.56376L0 8.46823L10.612 15.3727C12.042 16.294 13.544 16.9382 15.5227 16.9382C20.1731 16.9382 24 13.1149 24 8.46909C24 3.82326 20.1731 0 15.5227 0Z" fill="#38D200" />
            </svg></span>
    </h1>
    <form class="mt-12 lg:mt-64" action="{{ route('save') }}" method="POST">
        ...
        <div class="flex flex-col gap-6 lg:flex-row lg:gap-44 items-center lg:justify-between">
            <div class="flex w-full flex-grow-1 items-center gap-3 relative">
                ...
                <input type="number" name="mobile" placeholder="Mobile Number" class="block w-full px-4 py-2 border border-white rounded-full bg-transparent" pattern="\d*">
            </div>
            ...
            <div class="flex w-full items-center gap-3 relative">
                ...
                <select name="city" class="block w-full max-w-4xl px-4 py-2 border border-white rounded-full bg-transparent">
        ...
        <div class="text-center mt-10">
            <button type="submit" class="px-10 py-2 bg-transparent hover:bg-gradient-to-r from-[#0574EA] to-[#38D200] transition-colors duration-300 outline outline-1 text-white rounded-full mb-10 hover:outline-none">
                SUBMIT
            </button>
        </div>
    </form>
